...
void
DEBUGRecord_enter_scope(const int32_t id, const char* file, const char* func, const int32_t line, uint32_t hitcnt);

void
DEBUGRecord_exit_scope(const int32_t id, const float msecs);

const debug_record*
DEBUGRecord_records_begin();
const debug_record*
DEBUGRecord_records_end();
...
struct scoped_time_block
{
  ...
  public:
    scoped_time_block(const int32_t id, const char* file, const char* func, const int32_t line, uint32_t hitcnt = 1)
        : _id{ id }
    {
