...
void
app::animated_paper_plane::init() noexcept
{
...

    {
        ...
        gl::BufferData(gl::ARRAY_BUFFER, sizeof(plane_vertices), plane_vertices, gl::STATIC_DRAW);
    }

    {
        ...
        gl::BufferData(gl::ELEMENT_ARRAY_BUFFER, sizeof(plane_indices), plane_indices, gl::STATIC_DRAW);
    }

    {
        ...
        gl::BindVertexBuffer(0, raw_handle(vertex_buff_), 0, sizeof(xray::math::vec2f));
    ...
    {
        scoped_shader_handle vertex_shader{ make_shader(gl::VERTEX_SHADER, "shaders/vertex_coloring.glsl") };

        scoped_shader_handle fragment_shader{ make_shader(gl::FRAGMENT_SHADER, "shaders/basic_coloring.glsl") };
...
void
app::animated_paper_plane::update(const xray::scalar_lowp) noexcept
{
...
void
app::animated_paper_plane::draw(const xray::rendering::draw_context_t&) noexcept
{
    using namespace xray::math;
    ...
    gl::DrawElements(gl::LINES, XR_U32_COUNTOF__(plane_indices), gl::UNSIGNED_SHORT, nullptr);
}
