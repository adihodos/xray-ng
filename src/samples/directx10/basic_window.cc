...
static HMONITOR
get_primary_monitor_handle() noexcept
{
...
{
    {
        ...
        class_info.hbrBackground = reinterpret_cast<HBRUSH>(GetStockObject(COLOR_WINDOW + 1));
...

    {
        ...
        window_handle_ = CreateWindowEx(0L,
                                        basic_window::class_name,
                                        title ? title : "Simple window",
                                        wnd_style,
                                        0,
                                        0,
...
LRESULT
xray::ui::win32::basic_window::wnd_proc_stub(HWND wnd, UINT msg, WPARAM w_param, LPARAM l_param)
{
    if (msg == WM_NCCREATE) {
    ...
    if (auto obj_ptr = reinterpret_cast<basic_window*>(GetWindowLongPtr(wnd, GWLP_USERDATA))) {
...
LRESULT
xray::ui::win32::basic_window::window_proc(UINT msg_code, WPARAM w_param, LPARAM l_param)
{
...
void
xray::ui::win32::basic_window::pump_messages()
{
