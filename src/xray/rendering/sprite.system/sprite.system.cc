...
void
SpriteSystem::draw_scaled_rotated(const float x,
                                  const float y,
                                  const float width,
                                  const float height,
                                  const float scale,
...

{
    ...
    vec2f32 v0 = vec2f32{ x, y + height };
    vec2f32 v1 = vec2f32{ x + width, y + height };
    vec2f32 v2 = vec2f32{ x + width, y };
    vec2f32 v3 = vec2f32{ x, y };

    //
    // translate to origin
    const vec2f32 o = vec2f32{ x + width * 0.5f, y + height * 0.5f };
    v0 = v0 - o;
    v1 = v1 - o;
    v2 = v2 - o;
    v3 = v3 - o;
