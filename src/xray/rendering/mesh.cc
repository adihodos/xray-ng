...
// inline OutputVectorType vector_cast(const InputVectorType& input_vec)
// noexcept {
...
//  return {
//    fmt_traits::components, fmt_traits::bytes_size,
...
//
//  constexpr size_t INDEX_ELEMENT_SIZE[] = {sizeof(uint16_t),
//  sizeof(uint32_t)}; const auto       index_buffer_bytes_size =
...
//    aiProcess_FindDegenerates |          // remove degenerated polygons from
//    the aiProcess_FindInvalidData |          // detect invalid model data,
//    such as aiProcess_GenUVCoords |       // convert spherical, cylindrical,
//    box and aiProcess_TransformUVCoords | // preprocess UV transformations
...
//    post_processing_opts | (load_options &
//    mesh_load_option::convert_left_handed
...
//    { GLuint vao{}; gl::CreateVertexArrays(1, &vao); gl::BindVertexArray(vao);
...
//
//  tmr.end();
//  XR_LOG_TRACE("Mesh aabb parallel reduce took {} msec",
//  tmr.elapsed_millis());
//
