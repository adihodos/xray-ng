...
void xray::ui::detail::default_opengl_debug_sink::setup(
  ...
  gl::DebugMessageControl(gl::DONT_CARE, gl::DONT_CARE, gl::DEBUG_SEVERITY_LOW,
                          0, nullptr,
  ...
  gl::DebugMessageControl(gl::DONT_CARE, gl::DONT_CARE, gl::DEBUG_SEVERITY_HIGH,
                          0, nullptr,
...
void xray::ui::basic_window::mouse_button_stub(GLFWwindow* wnd, int32_t button,
                                               int32_t action,
                                               int32_t modifiers) {
...
void xray::ui::basic_window::mouse_scroll_stub(GLFWwindow* wnd, double x_offset,
                                               double y_offset) {
  (void) x_offset;
  auto wnd_ptr = static_cast<basic_window*>(glfwGetWindowUserPointer(wnd));
  assert(wnd_ptr != nullptr);
...
void xray::ui::basic_window::window_resized(GLFWwindow* window, int32_t width,
                                            int32_t height) {
  auto wnd_ptr = static_cast<basic_window*>(glfwGetWindowUserPointer(window));
  assert(wnd_ptr != nullptr);
