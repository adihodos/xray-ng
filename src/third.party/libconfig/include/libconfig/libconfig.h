...
extern LIBCONFIG_API int config_setting_set_string_with_len(config_setting_t *setting,
...
extern LIBCONFIG_API config_setting_t* config_setting_set_string_elem_with_len(
