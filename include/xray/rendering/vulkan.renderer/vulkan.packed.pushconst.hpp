...
struct PackedU32PushConstant
{
    ...
    PackedU32PushConstant(const xray::rendering::BindlessResourceHandle_StorageBuffer sbo,
    ...
    PackedU32PushConstant(const xray::rendering::BindlessResourceHandle_Image image,
                          const uint32_t instance_entry,
                          const uint32_t frame) noexcept
    {
