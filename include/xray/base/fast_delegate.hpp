...
template <typename RetType, typename... Args>
fast_delegate<RetType (Args...)> make_delegate(RetType (*func)(Args...)) {
    return fast_delegate<RetType (Args...)>(func);
}

template <typename RetType, typename X, typename Y, typename... Args>
fast_delegate<RetType (Args...)> make_delegate(Y& x, RetType (X::*func)(Args...)) {
    return fast_delegate<RetType (Args...)>(&x, func);
}

template <typename RetType, typename X, typename Y, typename... Args>
fast_delegate<RetType (Args...)> make_delegate(Y& x, RetType (X::*func)(Args...) const) {
    return fast_delegate<RetType (Args...)>(&x, func);
}
