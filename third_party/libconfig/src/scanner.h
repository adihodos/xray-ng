...
void libconfig_yy_switch_to_buffer(YY_BUFFER_STATE new_buffer,
                                   yyscan_t        yyscanner);
YY_BUFFER_STATE libconfig_yy_create_buffer(FILE* file, int size,
                                           yyscan_t yyscanner);
...
YY_BUFFER_STATE libconfig_yy_scan_buffer(char* base, yy_size_t size,
                                         yyscan_t yyscanner);
YY_BUFFER_STATE libconfig_yy_scan_string(yyconst char* yy_str,
                                         yyscan_t      yyscanner);
YY_BUFFER_STATE libconfig_yy_scan_bytes(yyconst char* bytes, yy_size_t len,
                                        yyscan_t yyscanner);
