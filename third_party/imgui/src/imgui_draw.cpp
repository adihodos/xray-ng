...
void ImDrawList::ChannelsSetCurrent(int idx) {
  ...
  memcpy(
    &_Channels.Data[_ChannelsCurrent].IdxBuffer, &IdxBuffer, sizeof(IdxBuffer));
  _ChannelsCurrent = idx;
  memcpy(
    &CmdBuffer, &_Channels.Data[_ChannelsCurrent].CmdBuffer, sizeof(CmdBuffer));
  memcpy(
    &IdxBuffer, &_Channels.Data[_ChannelsCurrent].IdxBuffer, sizeof(IdxBuffer));
...
void ImDrawList::PathBezierCurveTo(const ImVec2& p2,
  ...
  if (num_segments == 0) {
    ...
    PathBezierToCasteljau(&_Path,
                          ...
                          p4.x,
                          p4.y,
                          GImGui->Style.CurveTessellationTol,
                          0);
  } else {
